...
I have learned the increasing prominence of open source data sharing in research. In the same vein, this analysis was performed using RStudio & the rMarkdown file & all other associated data files are available on GitHub.